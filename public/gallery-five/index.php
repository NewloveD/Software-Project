...
<html lang="en">
    <head>
        ...
        <link rel="canonical" href="https://www.example.com/gallery-five/">
        ...
        <meta property="og:url" content="https://www.example.com/gallery-five/"/>
...
<?php include ("../NavPort/Headernav.php") ?>
    ...
    <section id="int-hero">
        <h1 id="home-h">Partnering With Police Unions</h1>
        <picture>
            <source media="(max-width: 600px)" srcset="../assets/images/Gallery/Partnering-with-Police-Unions/Police-Union.jpeg">
            <source media="(min-width: 601px)" srcset="../assets/images/Gallery/Partnering-with-Police-Unions/Police-Union.jpeg">
            ...
            <div class="cs-image-group">
                ...
                <div class="cs-row cs-row-1">
                    <picture class="cs-picture cs-picture1">
                        <source media="(max-width: 600px)" srcset="../assets/images/Gallery/Partnering-with-Police-Unions/Police-Union.jpeg">
                        <source media="(min-width: 601px)" srcset="../assets/images/Gallery/Partnering-with-Police-Unions/Police-Union.jpeg">
                        <img aria-hidden="true" decoding="async" src="../assets/images/Gallery/Partnering-with-Police-Unions/Police-Union.jpeg" alt="new hallway" loading="lazy" width="400" height="560">
                    </picture>
                    <picture class="cs-picture cs-picture2">
                        <source media="(max-width: 600px)" srcset="../assets/images/Gallery/Partnering-with-Police-Unions/Police-Union1.jpeg">
                        <source media="(min-width: 601px)" srcset="../assets/images/Gallery/Partnering-with-Police-Unions/Police-Union1.jpeg">
                        <img aria-hidden="true" decoding="async" src="../assets/images/Gallery/Partnering-with-Police-Unions/Police-Union1.jpeg" alt="new home construction" loading="lazy" width="400" height="560">
                    </picture>
                ...
                <div class="cs-row cs-row-2">
                  <picture class="cs-picture cs-picture1">
                    <source media="(max-width: 600px)" srcset="../assets/images/Gallery/Partnering-with-Police-Unions/Police-Union2.jpeg">
                    <source media="(min-width: 601px)" srcset="../assets/images/Gallery/Partnering-with-Police-Unions/Police-Union2.jpeg">
                    <img aria-hidden="true" decoding="async" src="../assets/images/Gallery/Partnering-with-Police-Unions/Police-Union2.jpeg" alt="new hallway" loading="lazy" width="400" height="560">
                </picture>
                <picture class="cs-picture cs-picture2">
                    ...
                    <img aria-hidden="true" decoding="async" src="../assets/images/Gallery/Partnering-with-Police-Unions/Police-Union3.jpeg" alt="new home construction" loading="lazy" width="400" height="560">
                </picture>
                    <!-- To add more images, copy and paste this row's picture tags here in order from cs-picture-1 to cs-picture-3 and they will maintain the same layout-->
                </div>
                <!-- Row 3 -->
                <div class="cs-row cs-row-3">
                  <picture class="cs-picture cs-picture1">
                    <source media="(max-width: 600px)" srcset="../assets/images/Gallery/Partnering-with-Police-Unions/Police-Union4.jpeg">
                    <source media="(min-width: 601px)" srcset="../assets/images/Gallery/Partnering-with-Police-Unions/Police-Union4.jpeg">
                    <img aria-hidden="true" decoding="async" src="../assets/images/Gallery/Partnering-with-Police-Unions/Police-Union4.jpeg" alt="new hallway" loading="lazy" width="400" height="560">
                </picture>
